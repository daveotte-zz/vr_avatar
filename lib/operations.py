...
class predictElbowPosOnly(operation):
    def __init__(self):
        super(predictElbowPosOnly, self).__init__()
        self.skipJoints = ['rForeArm','rHand']
    ...
    def operate(self,transformList):
        ...
        self.inputArray  = util.getPosArray(rHandMx4).tolist() \
                    + util.getRotArray(headMx4).tolist() \
        ...
        #for draw
        self.manipulatedTransforms = [headMx4]
        self.manipulatedPositions = [util.getPosArray(rHandMx4),util.getPosArray(lHandMx4),self.outputArray]
